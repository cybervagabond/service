...
func main() {
	...
	fs.String("damata-path", "/data", "data local path")
	fs.String("config-path", "", "config dir path")
	fs.String("config", "config.yaml", "config file name")
	fs.String("ui-path", "/home/tester/go/src/service/ui", "UI local path")
	fs.String("ui-logo", "https://raw.githubusercontent.com/cybervagabond/service/gh-pages/cuddle_clap.gif", "UI logo")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/cybervagabond/service/gh-pages/cuddle_clap.gif")
